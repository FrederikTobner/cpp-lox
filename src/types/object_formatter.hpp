...
inline auto std::formatter<cppLox::Types::Object *>::format(cppLox::Types::Object * object,
                                                            format_context & ctx) const {
    switch (object->type()) {
    case cppLox::Types::Object::Type::STRING:
        return formatter<string_view>::format(std::format("{}", object->as<cppLox::Types::ObjectString>()->string()),
                                              ctx);
